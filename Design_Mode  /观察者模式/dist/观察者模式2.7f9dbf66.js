...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"观察者模式2.ts":[function(require,module,exports) {
"use strict";
...
var Xueba = /** @class */function (_super) {
  ...
  Xueba.prototype.update = function () {
    if (this.teacher.getState() == '老师提问') {
      console.log("".concat(this.teacher.getState(), " \u5B66\u9738\u62AC\u5934\u4E3E\u624B"));
    }
  };
  return Xueba;
}(Student);
var XueZha = /** @class */function (_super) {
  ...
  XueZha.prototype.update = function () {
    if (this.teacher.getState() == '老师提问') {
      console.log("".concat(this.teacher.getState(), " \u5B66\u6E23\u4F4E\u5934\u770B\u811A"));
    }
  };
  return XueZha;
}(Student);
...
var Promise = /** @class */function () {
  function Promise(task) {
    ...
    var resolve = function resolve() {
      _this.successes.forEach(function (success) {
        return success();
      });
    };
    task(resolve);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","观察者模式2.ts"], null)
//# sourceMappingURL=/观察者模式2.7f9dbf66.js.map